...
$stmt = $db->runQuery("UPDATE milk SET amount = :amout,litres = :lites,date_added = :dates,unitp=:unitp WHERE id = :post_id and famer_id=:farmerid");
$stmt->execute(array(":amout" => $amout,":farmerid" => $farmerid ,":lites" => $lites,":dates" => $dates,":post_id" => $post_id, ":unitp" => $unitp));
	...
	<div class="modal-body">
              ...
              <div class="box-body">
                <div class="form-group">
                  <label for="inputEmail3" >Cost Price</label>
...
$stmt = $db->runQuery("insert into milk(amount,litres,famer_id,date_added,unitp)values(:amout,:lites,:farmerid,:dates,:unitp)");
$stmt->bindValue(":amout", $amout);
$stmt->bindValue(":lites", $lites);
$stmt->bindValue(":unitp", $unitp);
