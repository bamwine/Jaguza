        ...
        <div class="col-lg-4 col-xs-6">
          ...
          <div class="small-box ">
		   <a  class="small-box-footer bg-green">Total Districts </a>
            ...
            <a href="admin.php?page=an" class="small-box-footer">View more<img src="icons/send.png"/></a>
          </div>
        </div>
		 ...
		 <div class="col-lg-4 col-xs-6">
          ...
          <div class="small-box ">
		   <a  class="small-box-footer bg-yellow">Registed Farmers </a>
            ...
            <a href="admin.php?page=fb" class="small-box-footer ">View more <i class="fa fa-arrow-circle-right " ></i></a>
          </div>
        </div>
		 ...
		 <div class="col-lg-4 col-xs-6">
          ...
          <div class="small-box ">
		   <a  class="small-box-footer bg-aqua">Farms Registerd </a>
            ...
            <a href="admin.php?page=na" class="small-box-footer">View more <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
