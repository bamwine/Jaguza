...
$(document).ready(function() {
 ...
 $.fn.dataTable.Buttons.swfPath = '../../plugins/funny_tables/flashExport.swf';
$(document).ready(function() {
    $('#report_table').DataTable( {
        dom: 'Bfrtip',
        buttons: [
...
$(document).ready(function() {
$.fn.dataTable.Buttons.swfPath = 'plugins/datatables/extensions/TableTools/swf/copy_csv_xls_pdf.swf';
    $('#report_table').DataTable( {
        dom: 'Bfrtip',
		 "SwfPath": "plugins/datatables/extensions/TableTools/swf/copy_csv_xls_pdf.swf",
        buttons: [
		'excelHtml5',
            'csvHtml5',	
            {
                extend: 'print',
				title: header(),
				//message: 'Report Made by Jaguza Application',
                exportOptions: {
                 modifier: {
                    page: 'current'
                }
                },customize: function (win) {
                $(win.document.body).find('table').addClass('display').css('font-size', '30px');
				...
				$(win.document.body)
                        .css( 'font-size', '10pt' )
                        .prepend(
                            '<center><img src="http://localhost/Jaguza/icons/logo.png" style=" top:0; left:0; margin: auto;" /></center>'
                        );
