          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tbody>
				<?php  
				$vetid =$userRow['vet_id'];
				$s = $db->runQuery( "SELECT * FROM logs where status='yes' and vet_id=:vetid" );
				$s->execute(array(":vetid" => $vetid));
			   ...
			   <a  class="btn btn-danger pull-right" style="margin-right: 5px;" title="Edit response " onclick="$('#repose_<?php echo $row['id']; ?>').modal('show');"><i class="fa fa-pencil"></i></a>
                  ...
                  <div class="modal-header orange_header">
					...
					<div class="modal-body">
					 <div class="row">
					  ...
					  <b><p>Response</p></b> <p><?php echo $row['feedback']; ?></p><br/>
 ...
 <div id="repose_<?php echo $row['id']; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header orange_header">
                    <button aria-label="Close" data-dismiss="modal" class="close" type="button"><span aria-hidden="true"><i class="fa fa-close"></i></span></button>
                    <h3 class="modal-title">Response -Edit</h3>
                  </div>
					...
					<textarea type="text" class="form-control" id="feedback" name="feedback" reqiured ><?php echo $row['feedback']; ?></textarea>
...
header("Location: vet_doc.php?page=mw");
...
function deleteFund(Id){
	...
	if(iAnswer){		
        ...
        window.location = "vet_doc.php?page=mw&did="+Id;
...
feedback = :feedback,
vet_id=:vet_id
WHERE id = :p_id and farmer_id=:farmer_id");
