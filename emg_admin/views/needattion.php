...
$userRow = $stmt->fetch(PDO::FETCH_ASSOC);
          ...
          <div class="box">
            <div class="box-header with-border bg-green-gradient">
			 <i class=""><img src="icons/time.png" height="20px;" width="20px;" /></i>
              <h3 class="box-title">Temperatures for animals needing Attention.</h3>
  ...
  $farmerid = $userRow['fa_id'];
	$result = $db->runQuery("SELECT tag_id ,temp FROM monitor WHERE famer_id = :farmerid  LIMIT 5");
...
?>
	  ...
	  <div class="box box-solid bg-green-gradient">
            <div class="box-header">
              ...
              <h3 class="box-title">Top Five animals </h3>
              <!-- tools box -->
            ...
            <table  class="table " >
				...
				<?php  //if you are outside the db class, for example you are in the index page
					$farmerid = $userRow['fa_id'];
					$s = $db->runQuery("SELECT * FROM monitor WHERE famer_id = :farmerid  LIMIT 5");
